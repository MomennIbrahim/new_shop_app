...
import '../../../data/repository/person_repository_implementation.dart';
...
class ChangePasswordScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          ChangePasswordCubit(getIt.get<PersonRepositoryImplementation>()),
        ...
        listener: (context, state) {
          if (state is ChangePasswordLoadingState) {
            ...
            if (state.userModel.status == true) {
              EasyLoading.dismiss();
              customNavigator(context: context, widget: const LayoutScreen());
