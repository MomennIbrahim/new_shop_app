...
import 'package:route_app/features/person/presentation/screens/person_screen/widgets/sign_out_button.dart';
import 'package:route_app/features/person/presentation/screens/person_screen/widgets/user_mobile_phone.dart';
import 'package:route_app/features/person/presentation/screens/person_screen/widgets/user_name.dart';
    ...
    return BlocBuilder<PersonCubit, PersonState>(
      builder: (context, state) {
        if (state is GetPersonSuccessState) {
          ...
          return const Center(child: LoadingPersonScreen());
        }
      },
    );
  }
