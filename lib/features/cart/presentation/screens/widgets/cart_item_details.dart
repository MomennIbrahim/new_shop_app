...
class CartItemDetailsScreen extends StatefulWidget {
  CartItemDetailsScreen({super.key, required this.index});

  final int index;
   int _currentSlide=0;

  @override
  State<CartItemDetailsScreen> createState() => _CarouselBannersState();
}

class _CarouselBannersState extends State<CartItemDetailsScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                        ...
                        children: state
                            .cartsModel.data!.cartItems![widget.index].product!.images!
                            .map((e) {
                          int index = state
                              .cartsModel.data!.cartItems![widget.index].product!.images!
                              .indexOf(e);
                    ...
                    ProductName(
                      name: state.cartsModel.data!.cartItems![widget.index].product!.name
                          .toString(),
                    ),
                    SizedBox(
                      height: 24.h,
                    ...
                    Text(
                      state.cartsModel.data!.cartItems![widget.index].product!.description
                          .toString(),
                      style:
                    ...
                    Row(
                      children: [
                        PriceText(price: 'EGP ${state.cartsModel.data!.cartItems![widget.index].product!.price}'),
                        SizedBox(width: 10.w,),
                        AddToCartButton(model: state.cartsModel.data!.cartItems![widget.index].product!.id,),
